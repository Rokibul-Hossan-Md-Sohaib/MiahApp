    ...
    <View>
      ...
      {subcategory
              ...
              <ScrollView>
                <View>
                  ...
                  <View style={{flex: 1, flexDirection: 'row'}}>
                    ...
                    <Pressable
                      onPress={() =>
                        navigation.navigate('SubSubCat', {name: subCat.slug})
                      }
                      >
                      <Text
        ...
        : null}
            <Pressable 
             onPress={() =>
              navigation.navigate('catSub', {name: nameSub})
            }
            >
    <Text  style={{fontSize: 15, marginTop: 10, marginLeft: 10}}>All {nameSub}</Text>
    </Pressable>
    </View>
  );
};
